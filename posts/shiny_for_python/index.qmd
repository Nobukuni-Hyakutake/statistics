...
下記のコードを[app.py](https://github.com/Nobukuni-Hyakutake/statistics/blob/main/trial/shiny_dashboard_02/app.py)として保存する。
...
下記のコードを[file1.py](https://github.com/Nobukuni-Hyakutake/statistics/blob/main/trial/shiny_dashboard_02/file1.py)として保存する。
